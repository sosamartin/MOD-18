...
# Step 2: Modify the Epxisting Block Data Class to Store Record Data
...
#st.set_page_config(page_title="PyChain", page_icon=":sunglasses:")
st.title("PyChain: A Python Blockchain")
pychain = PyChain([Block(record=Record("Initial Block", "", 0), creator_id=0)])
